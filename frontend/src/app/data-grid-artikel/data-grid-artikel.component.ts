...
export class DataGridArtikelComponent implements OnInit {
    ...
    fetchDataByDepartmentId(): void {
        ...
        this.httpService.get_httpclient().get(`${this.httpService.get_baseUrl()}/artikel/get_artikels`, {params})
    ...
    exportArtikels() {
        ...
        this.httpService.get_httpclient()
            .get(`${this.httpService.get_baseUrl()}/artikel/export`, {
                responseType: 'json',
                params: params
            })
            .subscribe({
                next: (response: any) => {
                    ...
                    a.download = 'zm32_artikelliste' + dateString + '.xlsx';
                    a.click();
