...
} from "./data-grid-artikel/material-edit-component/material-edit-component.component";
...
} from "./data-grid-bestellungen/bestellung-edit-component/bestellung-edit-component.component";
...
} from "./data-grid-artikel/lieferant-edit-component/lieferant-edit-component.component";
import {
    HerstellerEditComponentComponent
} from "./data-grid-artikel/hersteller-edit-component/hersteller-edit-component.component";
...
export function appInitializer(httpService: HttpService) {
    return () =>
        localStorage.setItem('apiBaseUrl', httpService.get_baseUrl());
}
